...
<div class="clearfix"></div>
          <main>
           <div class="container content_wrap">
                ...
                <h1 class="sec_title">아이디 찾기 결과</h1>
<div class="col-sm-2 col-md-3"></div>
               <div class="col-sm-8 col-md-6">
                <div class="find_wrap">
    <div class="mem_form_wrap">
            <p class="find_text"><span class="find_id"><?= $row["u_id"]?></span>&nbsp;&nbsp;(<?= $row["u_regdate"]?> 가입)</p>
            <p>아이디 찾기 결과는 위와 같습니다.</p><br>
        <div class="row"><div class="col-md-2"></div>
            <div class="col-md-8">
        <a class="btn-default" href="login.php">로그인</a>
            <a class="btn-default" href="find_mem.php" onclick="#pwdChk">비밀번호 찾기</a></div>
            </div><br>
    </div></div>
</div></div><div class="col-sm-2 col-md-3"></div><div class="clearfix"></div><br>
<?php
}
