...
if ($exist_id){
    ...
    $sql="insert into member(u_id, u_pwd, u_name, u_gender, u_birthdate, u_tel, u_regdate)";
    $sql.="values('$u_id', '$u_pwd', '$u_name', '$u_gender', '$u_birthdate', '$u_tel', '$u_regdate')";
    mysqli_query($conn, $sql);
  }
  mysqli_close($conn);
?>
<script>
    alert ("정광사 템플스테이 회원이 되신걸 축하합니다.");
